            ...
            <div className={s.userMainInfo}>
                <div className={s.userMainInfoContainer}>
                    <div className={s.circleAvatar}>
                        <img src="http://demo.foxthemes.net/instellohtml/assets/images/post/img3.jpg" alt=""/>
                    </div>
                    <div className={s.userInfo}>
                        <div className={s.nameOfUser}>Vladislav Khamitsky</div>
                        <div className={s.aboutUser}> Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                            Consectetur delectus eius expedita
                            explicabo illo odit placeat qui quo rem voluptatum. Dolorem enim hic impedit necessitatibus
                            perspiciatis repellat sapiente, veniam voluptatum!
                        </div>
                        ...
                        <div className={s.infoAboutFollowers}><div>120k <span>posts</span></div>|<div>420k <span>followers</span></div>|<div> 530k <span>followers</span></div></div>
                    </div>
                </div>
                <br/><br/>
